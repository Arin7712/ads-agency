...
const page = () => {
  return (
    <div className="grain flex flex-col justify-between lg:py-10 md:py-[2rem] py-[4rem] lg:px-[6rem] px-6 bg-black text-white">
      <Navbar />
      <div className="md:mt-[8rem] mt-[4rem] flex flex-col">
        ...
        <div className="flex lg:justify-end lg:items-end flex-col gap-6 ">
          ...
          <p className="lg:w-[50%] lg:text-4xl font-medium leading-none">
            <span className="font-bold">VISION®</span> is a global agency
