...
const Featured = () => {
  ...
  return (
    <div className="relative flex flex-col pt-10 md:py-20 md:px-24 px-6 text-neutral-900 gap-20 md:gap-24">
      {/* Title */}
      ...
      <div className="overflow-x-scroll no-scrollbar w-full" ref={scrollRef}>
        <div className="flex gap-24 w-max">
          {featuredItems.map((item, index) => (
            <div key={index} className="flex flex-col justify-between md:w-96 w-80 md:h-80 h-60">
      ...
      <div className="w-full">
        <div className="w-full h-[2px] bg-neutral-300 relative overflow-hidden">
          <div
